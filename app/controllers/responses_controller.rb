class ResponsesController < ApplicationController
  ...
  def complete
    ...
    if @response.errors.empty? && @response.update_attributes(params[:response].except(:answers_attributes)) && @response.update_answers(params[:response][:answers_attributes])
      @response.complete
